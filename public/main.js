...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/Marcus/Desktop/pomodoro/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/Marcus/Desktop/pomodoro/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _containers = __webpack_require__(162);
	...
	var timer = (0, _redux.combineReducers)(reducers);

	var logger = (0, _reduxLogger2.default)();
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)()(
	// logger
	_redux.createStore);
	var store = createStoreWithMiddleware(timer);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Marcus/Desktop/pomodoro/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_Component) {
	  ...
	  function App() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(App)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.incrementSessionLength = function () {
	      _this.props.incrementSession();
	    }, _this.decrementSessionLength = function () {
	      _this.props.decrementSession();
	    }, _this.incrementBreakLength = function () {
	      _this.props.incrementBreak();
	    }, _this.decrementBreakLength = function () {
	      _this.props.decrementBreak();
	    }, _this.startTimer = function () {
	      _this.interval = setInterval(function () {
	        _this.props.startSession();
	      }, 1000);
	    }, _this.stopTimer = function () {
	      clearInterval(_this.interval);
	      _this.props.stopSession();
	    }, _this.resetTimer = function () {
	      clearInterval(_this.interval);
	      _this.props.resetSession();
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      var pomodoro = this.props.pomodoro;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_components.TimerControls, {
	          startClick: this.startTimer,
	          stopClick: this.stopTimer,
	          resetClick: this.resetTimer,
	          disableStartBtn: pomodoro.active }),
	        _react2.default.createElement(_components.SessionControls, {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({
	    incrementSession: _actions.incrementSession,
	    decrementSession: _actions.decrementSession,
	    incrementBreak: _actions.incrementBreak,
	    decrementBreak: _actions.decrementBreak,
	    startSession: _actions.startSession,
	    stopSession: _actions.stopSession,
	    resetSession: _actions.resetSession
	  }, dispatch);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapActionCreators = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SessionControls = __webpack_require__(186);

	Object.defineProperty(exports, 'SessionControls', {
	  enumerable: true,
	  get: function get() {
	    return _SessionControls.SessionControls;
	  }
	});

	var _TimerControls = __webpack_require__(190);

	Object.defineProperty(exports, 'TimerControls', {
	  enumerable: true,
	  get: function get() {
	    return _TimerControls.TimerControls;
	  }
	});

	var _Timer = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SessionControls = undefined;
	...
	var _SessionButton = __webpack_require__(189);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var SessionControls = exports.SessionControls = function SessionControls(_ref) {
	  var breakTime = _ref.breakTime;
	  var sessionTime = _ref.sessionTime;
	  var increamentSession = _ref.increamentSession;
	  var decrementSession = _ref.decrementSession;
	  var increamentBreak = _ref.increamentBreak;
	  var decrementBreak = _ref.decrementBreak;
	  var disableBtn = _ref.disableBtn;
	  return _react2.default.createElement(
	    'div',
	    { className: 'session-controller-container' },
	    _react2.default.createElement(
	      'div',
	      { className: 'session-controller' },
	      _react2.default.createElement(
	        'p',
	        { className: 'session-controller__header' },
	        'Break Length'
	      ),
	      _react2.default.createElement(
	        'p',
	        { className: 'session-controller__value' },
	        _react2.default.createElement(_SessionButton.SessionButton, {
	          increment: false,
	...
	SessionControls.propTypes = {
	  increamentSession: _react2.default.PropTypes.func.isRequired,
	  decrementSession: _react2.default.PropTypes.func.isRequired,
	  increamentBreak: _react2.default.PropTypes.func.isRequired,
	  decrementBreak: _react2.default.PropTypes.func.isRequired,
	  sessionTime: _react2.default.PropTypes.number.isRequired,
	  breakTime: _react2.default.PropTypes.number.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SessionButton = undefined;
	...
	var SessionButton = exports.SessionButton = function SessionButton(_ref) {
	  var increment = _ref.increment;
	  var sessionType = _ref.sessionType;
	  var isDisabled = _ref.isDisabled;

	  var buttonStyle = increment ? "session-controller__btn--increament" : "session-controller__btn--decrement";
	  var buttonValue = increment ? "+" : "-";
	  return _react2.default.createElement(
	    "button",
	    {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Marcus/Desktop/pomodoro/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SessionButton.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TimerControls = undefined;
	...
	var TimerControls = exports.TimerControls = function TimerControls(_ref) {
	  var startClick = _ref.startClick;
	  var stopClick = _ref.stopClick;
	  var resetClick = _ref.resetClick;
	  var disableStartBtn = _ref.disableStartBtn;
	  return _react2.default.createElement(
	    'div',
	...
	TimerControls.propTypes = {
	  startClick: _react2.default.PropTypes.func.isRequired,
	  stopClick: _react2.default.PropTypes.func.isRequired,
	  resetClick: _react2.default.PropTypes.func.isRequired,
	  disableStartBtn: _react2.default.PropTypes.bool.isRequired
	};

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Marcus/Desktop/pomodoro/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TimerControls.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var secondsToHMS = function secondsToHMS(secs) {
	  secs = Number(secs);
	...
	var Timer = exports.Timer = function Timer(_ref) {
	  ...
	  var circleFill = 'c100 p' + percent + ' normal';
	  var timer = secondsToHMS(time);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = exports.Header = function Header(_ref) {
	  ...
	  var session = sessionType ? 'Session' : 'Break';
	...
	Header.propTypes = {
	  sessionType: _react2.default.PropTypes.bool.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.decrementBreak = exports.incrementBreak = exports.stopSession = exports.resetSession = exports.startSession = exports.decrementSession = exports.incrementSession = undefined;

	var _constants = __webpack_require__(200);

	var incrementSession = exports.incrementSession = function incrementSession() {
	  return {
	    type: _constants.INCREMENT_SESSION
	  };
	};

	var decrementSession = exports.decrementSession = function decrementSession() {
	  return {
	    type: _constants.DECREMENT_SESSION
	  };
	};

	var startSession = exports.startSession = function startSession() {
	  return {
	    type: _constants.START_TIMER
	  };
	};

	var resetSession = exports.resetSession = function resetSession() {
	  return {
	    type: _constants.RESET_TIMER
	  };
	};

	var stopSession = exports.stopSession = function stopSession() {
	  return {
	    type: _constants.STOP_TIMER
	  };
	};

	var incrementBreak = exports.incrementBreak = function incrementBreak() {
	  return {
	    type: _constants.INCREMENT_BREAK
	  };
	};

	var decrementBreak = exports.decrementBreak = function decrementBreak() {
	  return {
	    type: _constants.DECREMENT_BREAK
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var INCREMENT_SESSION = exports.INCREMENT_SESSION = 'INCREMENT_SESSION';
	var DECREMENT_SESSION = exports.DECREMENT_SESSION = 'DECREMENT_SESSION';
	...
	var INCREMENT_BREAK = exports.INCREMENT_BREAK = 'INCREMENT_BREAK';
	var DECREMENT_BREAK = exports.DECREMENT_BREAK = 'DECREMENT_BREAK';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pomodoro = exports.pomodoro = function pomodoro() {
	  ...
	  switch (action.type) {
	    case _constants.INCREMENT_SESSION:
	    ...
	    case _constants.DECREMENT_SESSION:
	    ...
	    case _constants.INCREMENT_BREAK:
	      if (state.breakLength > 29) {
	        return state;
	      }
	      return _extends({}, state, {
	        breakLength: state.breakLength + 1
	      });
	    case _constants.DECREMENT_BREAK:
	    ...
	    case _constants.STOP_TIMER:
	      return _extends({}, state, {
	        active: false
	      });
	    case _constants.RESET_TIMER:
	      return _extends({}, state, {
	        session: true,
	        time: state.sessionLength * 60,
	        totalTime: state.sessionLength * 60,
